...
export function makeTemplate(profile, name = 'My viol') {
  ...
  return { outer, holes, width: plateWidth, height: base, name: label,
    capHeight, contact, parameters: profile.params };
}
